...
namespace CadastroEmpresasLibrary.Classes
{
    ...
    {
        public static string CaminhoBD = @"Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=CadastroEmpresa;Data Source=VINIESPINOSA-PC\SQLEXPRESS";
        ...
        public SqlCommand GetSelectCommand()
        {
            ...
            try
            {
                ...
                _return.Connection.ConnectionString = CaminhoBD;
